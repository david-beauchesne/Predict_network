...
# clip <- rgeos::gIntersection(egsl_grid, egsl, byid = TRUE, drop_lower_td = TRUE)
    ...
    # Plot
    # Color palette
        rbPal <- colorRampPalette(c('#3BAAA0','#043576')) # color palette
        ...
        png('/users/davidbeauchesne/dropbox/phd/phd_obj2/Structure_Comm_EGSL/Predict_network/communication/linkDensity.png', width = 13, height = 13, pointsize = 25, units = 'in', res = 300)
